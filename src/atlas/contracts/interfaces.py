...
class ControlPlaneInterface(ABC):
    ...
    def check_permission(
        self, action: ProposedAction, ctx: ExecutionContext | None = None
    ) -> PolicyDecision: ...
    ...
    async def request_approval(
        self, request: ApprovalRequest, ctx: ExecutionContext | None = None
    ) -> ApprovalResult: ...
...
class SkillEngineInterface(ABC):
    ...
    @abstractmethod
    async def invoke(
        self, skill_id: str, params: dict[str, Any], ctx: ExecutionContext | None = None
    ) -> SkillResult: ...
